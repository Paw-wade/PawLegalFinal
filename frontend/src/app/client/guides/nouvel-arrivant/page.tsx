...
function BanqueCards({ options }: { options: BanqueOption[] }) {
  return (
  ...
  return (
    <div className="px-4 pb-5 pt-3 border-t border-gray-100 space-y-4">
      ...
      {step.special === 'banque' && step.banqueOptions && step.banqueOptions.length > 0 && (
        <BanqueCards options={step.banqueOptions} />
      )}
    </div>
  );
}

export default function GuideNouvelArrivantPage() {
