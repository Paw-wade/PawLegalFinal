...
async function main() {
  ...
  console.log('     127.0.0.1 dupont.localhost martin.localhost');
  console.log('   Ou utilisez X-Tenant-Slug: cabinet-dupont | cabinet-martin');
  console.log('   localhost → DEFAULT_ORG_SLUG=cabinet-dupont (voir .env.multi-tenant.example)');
