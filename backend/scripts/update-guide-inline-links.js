...
La validation se fait sur [l'ANEF (Administration des Etrangers en France)](https://administration-etrangers-en-france.interieur.gouv.fr/particuliers/#/) :
...
Si votre visa porte la mention "D" (long sejour classique, sans la mention VLS-TS), vous devez faire une demande de titre de sejour etudiant sur [l'ANEF](https://administration-etrangers-en-france.interieur.gouv.fr/particuliers/#/) dans les 2 mois suivant votre arrivee. Preparez : passeport + visa valide, justificatif d'inscription dans l'etablissement, justificatif de logement, justificatif de ressources financieres et deux photos d'identite.`,
    ...
    },
    {
      ...
      description: "Creer un compte et regler la CVEC sur [cvec.etudiant.gouv.fr](https://cvec.etudiant.gouv.fr) avant l'inscription administrative dans l'etablissement. Une attestation numerotee est delivree immediatement apres paiement. Ce numero sera demande par l'universite lors de l'inscription.",
...
L'inscription se fait en ligne (francais, anglais, espagnol) apres l'inscription dans l'etablissement, sur [etudiant-etranger.ameli.fr](https://etudiant-etranger.ameli.fr). Pieces a preparer :
...
- [LMDE](https://www.lmde.com), SMENO, Heyme, MEP : mutuelles dediees aux etudiants, avec des tarifs adaptes
- Mutuelle de l'etablissement : certaines universites negocient des contrats collectifs avantageux
- [Complementaire Sante Solidaire (CSS)](https://www.complementaire-sante-solidaire.gouv.fr) : gratuite ou quasi-gratuite pour les boursiers et etudiants aux revenus modestes
...
3. La location d'appartement : plus d'independance, mais loyers plus eleves et garanties exigees par les proprietaires. Documents generalement demandes pour le dossier locataire : piece d'identite, justificatif de revenus (contrat de travail, attestation de bourse), justificatif de domicile actuel, garant ou [Garantie Visale](https://www.visale.fr).

Ou chercher un logement :
- [Leboncoin](https://www.leboncoin.fr) : petites annonces de particuliers
- [SeLoger](https://www.seloger.com) : selection large, criteres de recherche avances
- [PAP - Particulier a Particulier](https://www.pap.fr) : annonces directes sans frais d'agence
- Agences immobilieres : des frais d'agence s'appliquent (generalement 1 mois de loyer)

Aides au logement disponibles :
- APL (Aide Personnalisee au Logement) : versee par la [CAF](https://www.caf.fr) si le logement est conventionne. Demande a faire des le premier mois.
- ALS (Allocation de Logement Social) : pour les personnes ne pouvant pas beneficier de l'APL. Egalement via la [CAF](https://www.caf.fr).
- [Garantie Visale](https://www.visale.fr) : caution locative gratuite fournie par Action Logement. A demander avant de commencer les visites.
- [Action Logement](https://www.actionlogement.fr) : aide specifique aux salaries du secteur prive.`,
      deadline: "",
      cost: "",
    ...
    },
    {
      ...
      description: "Deposer la demande de renouvellement en ligne sur [l'ANEF](https://administration-etrangers-en-france.interieur.gouv.fr/particuliers/#/), dans la rubrique \"Je renouvelle ou modifie mon titre\". Consultez egalement notre [Calculateur](/calculateur) pour estimer vos delais et couts.",
    ...
    },
    {
      ...
      description: `Le numero fiscal permet d'etre identifie par l'administration fiscale francaise. Il est necessaire pour effectuer une declaration de revenus, creer une entreprise, acceder a certains services bancaires ou demander certaines aides sociales.
...
- [Imagine'R](https://www.imaginer.fr) : abonnement annuel a tarif reduit pour les etudiants de moins de 26 ans et les scolaires en Ile-de-France. Reduction significative par rapport au Navigo classique. Demande a faire des l'inscription universitaire.
...
- Faux conseillers ou fausses agences d'admission : des personnes proposent des services payants pour des demarches gratuites (demande de visa, CVEC, securite sociale).
...
- Signalez toute arnaque sur [cybermalveillance.gouv.fr](https://www.cybermalveillance.gouv.fr).`,
  ...
  await guide.save();
  console.log('Guide mis a jour avec liens inline ! ' + guide.steps.length + ' etapes.');
