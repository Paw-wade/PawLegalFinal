...
Sanctions en cas de fraude et astuce Ilevia (Lille) :
Voyager sans titre de transport valable expose a une amende (procès-verbal). Sur le reseau Ilevia, le montant de base est de 50 euros, majore si non regularise dans les delais indiques sur le PV.

Astuce importante si vous etes controle sans titre sur Ilevia : ne payez jamais l'amende sur place. Prenez le PV, puis rendez-vous dans une agence Ilevia et souscrivez deux abonnements consecutifs. Une fois ces deux abonnements valides et presentes en agence, la demande de paiement de l'amende est annulee. Cette procedure est propre au reseau Ilevia et ne s'applique pas necessairement aux autres reseaux de transport.

Bons reflexes pour tous les reseaux :
- Privilegiez l'abonnement annuel plutot que mensuel : il est toujours moins cher et souvent fractionnable en paiement.
- Conservez toujours votre titre de transport valide lors de vos deplacements.
- Renseignez-vous en agence ou sur le site de votre reseau pour connaitre precisement les justificatifs a fournir : les conditions evoluent chaque annee.`;
  ...
  await guide.save();
  console.log('Etape 10 mise a jour avec sanctions et astuce Ilevia.');
